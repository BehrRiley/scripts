...
command_party:
    ...
    - choose <[args].get[1].to_lowercase>:
        	...
        	- choose <[args].get[2].to_lowercase||>:
                ...
                - case leader:
                	- if <[party].length> == 0:
                    	- narrate "<&c>You are not in a party."
                        - stop
                	- if <[args].get[3]||null> == null || <server.match_player[<[args].get[3]>]||null> == null && <player[<[args].get[3]>]||null> == null:
                    	- narrate "<&c>Player not found."
                        - stop
                    - define new_leader <server.match_player[<[args].get[3]>]||<player[<[args].get[3]>]>>
        ...
        - case kick:
            ...
            - if <[kicked]> == null:
        		- define kicked <player[<[args].get[2]>]||null>
            	- if <[kicked]> == null:
            		- narrate "<&c>Player not found."
                	- stop
