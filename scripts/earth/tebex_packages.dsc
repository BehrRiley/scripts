...
activate_perk:
    ...
    - choose <[perk]>:
        ...
        - case "spawn_supply_crates":
            ...
            - wait 10t
            - narrate targets:<player[AJ_4real]> "<&e><&l><[player]> has purchased <[amount]> supply crates from the store."
        - case "spawn_military_crates":
            ...
            - wait 10t
            - narrate targets:<player[AJ_4real]> "<&e><&l><[player]> has purchased <[amount]> military crates from the store."